...
class FormENeedleAssyController extends GetxController {
  ...
  Future<void> submitForm({
    ...
    try {
      final response = await Api.post("form-e-needle-assy", formData);
  ...
  Future<void> fetchFormENeedleAssy(String id) async {
    final data = (await Api.get("form-e-needle-assy/$id"))['data'];
