...
class FormFAssySyringeController extends GetxController {
  ...
  Future<void> fetchFormByTaskId(int taskId) async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-assy-syringe/$taskId?is_task_id=true');
  ...
  Future<bool> submitForm() async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-assy-syringe');
  ...
  Future<bool> updateForm(String formId) async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-assy-syringe/$formId');
