...
class FormFBlisterController extends GetxController {
  ...
  Future<void> fetchFormByTaskId(int taskId) async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-blister/$taskId?is_task_id=true');
  ...
  Future<bool> submitForm() async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-blister');
  ...
  Future<bool> updateForm(String formId) async {
    ...
    try {
      final uri = Uri.parse('${ApiConfig.baseUrl}/form-f-blister/$formId');
