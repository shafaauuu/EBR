...
class FormGInjectionController extends GetxController {
  ...
  Future<bool> submitForm(BuildContext context) async {
    try {
      ...
      var url = Uri.parse('${ApiConfig.baseUrl}/form-g-injection');
      ...
      if (response.statusCode == 201 || response.statusCode == 200) {
        ...
        await ArtSweetAlert.show(
          ...
          artDialogArgs: ArtDialogArgs(
            ...
            title: "Success",
            text: "Form G Injection submitted successfully",
          ),
        );
        return true;
      } else {
  ...
  Future<Map<String, dynamic>?> getFormByTaskId(int taskId) async {
    try {
      ...
      final response = await http.get(
        Uri.parse('${ApiConfig.baseUrl}/form-g-injection/$taskId?is_task_id=true'),
        headers: {
