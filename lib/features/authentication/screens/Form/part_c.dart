...
class _PartCState extends State<PartC> {
  ...
  Widget _buildMaterialSection(String title, Function(String?) onChanged, String? selectedValue) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            _buildDetailField("Component/Material Code", selected["code"] ?? "", true),
            _buildDetailField("UoM", selected["uom"] ?? "", true),
            _buildDetailField("Required Quantity", selected["reqQty"] ?? "", true),
  ...
  Widget _buildDetailField(String label, String value, bool readOnly,
