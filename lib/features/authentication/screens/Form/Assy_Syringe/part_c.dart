...
import '../../../controller/Form/C/form_c_assysyringe_controller.dart';
...
class _PartC_SyringeState extends State<PartC_Syringe> {
  late final FormCAssySyringeController controller;
  ...
  Widget build(BuildContext context) {
    print("Building PartC_Syringe widget");
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // Add a history button to show previous submissions
          IconButton(
