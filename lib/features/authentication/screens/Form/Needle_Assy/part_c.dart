...
class PartC_NeedleAssy extends StatefulWidget {
  final Task task;
  final String selectedMaterialCode;
  final int requiredQuantity;
  const PartC_NeedleAssy({super.key, required this.task, required this.selectedMaterialCode, required this.requiredQuantity});

  @override
  _PartC_NeedleAssyState createState() => _PartC_NeedleAssyState();
}

class _PartC_NeedleAssyState extends State<PartC_NeedleAssy> {
  late final FormCNeedleAssyController controller;
  ...
  void initState() {
    super.initState();
    controller = Get.put(FormCNeedleAssyController(widget.task,widget.selectedMaterialCode));
  ...
  Widget build(BuildContext context) {
    print("Building PartC_NeedleAssy widget");
