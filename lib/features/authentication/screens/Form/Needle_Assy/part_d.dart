...
class PartD_NeedleAssy extends StatefulWidget {
  final Task task;
  const PartD_NeedleAssy({super.key, required this.task});

  @override
  _PartD_NeedleAssyState createState() => _PartD_NeedleAssyState();
}

class _PartD_NeedleAssyState extends State<PartD_NeedleAssy> {
  Uint8List? _webImage;
